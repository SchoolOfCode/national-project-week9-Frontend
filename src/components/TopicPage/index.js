...
export default function TopicPage() {
    ...
    return (
        <div className='topic-section'>
            ...
            <Topic query="database" title="Week 5 - Databases" imgPath="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTER_wnWHgS2z0Kra1UyKRv-ez3DGqTOP4nzSDq-sYmEkF2m5-Gayi8NNFdATDeVLYYEQI&usqp=CAU"></Topic>
            ...
            <Topic query="react_advanced" title="Week 8 - React Advanced" imgPath="https://pluginicons.craft-cdn.com/react.svg?1527521614"></Topic>
            <Topic title="Week 9 - Agile" imgPath="https://cdn.vectorstock.com/i/thumb-large/69/21/agile-icon-methodology-development-scrum-vector-30766921.jpg"></Topic>
